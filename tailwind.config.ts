  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "very-high-match": "hsl(var(--very-high-match))",
        "high-match": "hsl(var(--high-match))",
        "low-match": "hsl(var(--low-match))",
        "low-match-light": "hsl(var(--low-match-light))",
        "very-low-match": "hsl(var(--very-low-match))",
        "very-low-match-light": "hsl(var(--very-low-match-light))",
      },
      borderRadius: {
        lg: "var(--radius)",
